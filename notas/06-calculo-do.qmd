...
utilizando la segunda letra del apellido de las personas.

2. No puede existir una flecha de $U$ a $X$, pues nada en $X$ responde a cambios en
...
causal (lado izquierdo con operador *do*) a una estadpística (lado derecho).
