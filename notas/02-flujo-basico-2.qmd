...
Nuestro ejemplo de la sección es poco realista. Usualmente, las pruebas que
...
de positivos potenciales en la población (pues la prueba es imperfedta), sino
...
donde $\theta_obs$ está dada por la fórmula de arriba. Sustituyendo:
